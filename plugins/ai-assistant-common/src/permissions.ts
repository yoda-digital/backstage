...
/** Permission required to chat with the AI assistant. */
export const aiAssistantChatPermission = createPermission({
  name: 'ai.assistant.chat',
  attributes: { action: 'create' },
});

/** Permission required to administer the AI assistant, e.g. manage modes. */
export const aiAssistantAdminPermission = createPermission({
  name: 'ai.assistant.admin',
  attributes: { action: 'update' },
});

/** All permissions defined by the AI Assistant plugin. */
